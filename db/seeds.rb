...
7.times { Contest.create!( event_name: FFaker::CheesyLingo.title, event_date: DateTime.now + rand(150), cell_value: rand(1..5), sport: FFaker::Sport.name, prizes: [FFaker::BaconIpsum.word, FFaker::BaconIpsum.word] )}
